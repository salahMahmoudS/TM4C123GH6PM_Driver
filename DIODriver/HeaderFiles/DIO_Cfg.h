...
#define DioConf_TEST_PORT_NUM                ((Dio_PortType)DIO_PORT_A) /* PORTF */
...
#define DioConf_SW1_CHANNEL_NUM              ((Dio_ChannelType)DIO_CHANNEL_F_4)  /* Pin 4 in PORTF */
#define DioConf_SW2_CHANNEL_NUM              ((Dio_ChannelType)DIO_CHANNEL_F_0)  /* Pin 0 in PORTF */
#define DioConf_TEST_CHANNEL_NUM             ((Dio_ChannelType)DIO_CHANNEL_A_0) /* PORTF */
