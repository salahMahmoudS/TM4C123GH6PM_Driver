...
#define MCU_PLLRIS_BIT						0x06					//This bit indicates that PLL timer reached ready state to lock

#define MCU_RCC_REGISTER					(*((volatile uint32*)(SYSTEM_CONTROL_BASE_ADDRESS + 0x060)))			//Run-mode clock configuration register
#define MCU_USESYSDIV_BIT					0x16

#define MCU_RCC2_REGISTER					(*((volatile uint32*)(SYSTEM_CONTROL_BASE_ADDRESS + 0x070)))			//Run-mode clock configuration 2 register
#define MCU_USERRCC2_BIT					0x1f					//This bit identifies main run mode clock configuration register to be RCC2
#define MCU_DIV400_BIT						0x1E					//This bit Add SYSDIV2LSB to the SYSDIV2 bit field, which makes the bitfield 7 divisor bits that control 400MHz PLL output
#define MCU_SYSDIV2LSB_BIT					0x16					//when SCB_DIV400_BIT is set, this acts as the least signifacnt bit in the SYSDIV2 divisor
#define MCU_USBPWRDWN_BIT					0x0E					//This bit powers down the USB PLL
#define MCU_PWRDWN2_BIT						0x0D					//This bit powers down the PLL 
#define MCU_BYPASS2_BIT						0x0B					//Configures the system output clock to be either PLL or Oscillator
...
#define		SYSTICK_STCTRL_ENABLE			0x00
#define		SYSTICK_STCTRL_INTEN			0x01	 
#define		SYSTICK_STCTRL_CLK_SRC			0x02
#define		SYSTICK_STCTRL_COUNT			16
